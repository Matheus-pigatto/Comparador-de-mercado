def criar_tabela_departamentos(db_path):
    import sqlite3
...
def criar_tabela_produtos(db_path)-> None:
    import sqlite3
...
def criar_tabela_preco(db_path)-> None:
    import sqlite3
    conn = sqlite3.connect(database=db_path)
    cursor = conn.cursor()
    cursor.execute('''
...
def criar_tabela_log_preco(db_path)-> None:
    import sqlite3
    conn = sqlite3.connect(database=db_path)
    cursor = conn.cursor()
